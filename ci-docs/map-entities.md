...
ms.locfileid: "8646079"
---
# <a name="map-entities-and-attributes"></a>Mapper les entités et attributs

**Mapper** est la première phase du processus d’unification des données. Le mappage comprend trois phases :
...
1. Accédez à **Données** > **Unifier** > **Mettre en correspondance**.
