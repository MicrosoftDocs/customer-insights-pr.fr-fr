...
Si les données ne sont pas conformes au schéma, le processus d’ingestion se termine avec des erreurs. Corrigez les données source ou le schéma et réingérez les données.
