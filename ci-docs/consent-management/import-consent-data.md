...
1. L’étape **Modifier les requêtes** vous permet de renommer la requête et [d’appliquer des transformations de données à l’aide de Power Query](/power-query/power-query-ui). 
