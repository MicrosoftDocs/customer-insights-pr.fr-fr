...
---
# <a name="whats-new-in-the-audience-insights-capability-of-dynamics-365-customer-insights"></a>Nouveautés de la fonctionnalité Audience Insights de Dynamics 365 Customer Insights
...
Vous pouvez également regarder la vidéo suivante pour en savoir plus sur les fonctionnalités prévues pour les six derniers mois.
...
- **Se connecter à votre compte de stockage Azure Data Lake à l'aide d'un principal de service**
  ...
  Pour plus d'informations, consultez [Se connecter à un compte Azure Data Lake Storage Gen2 avec un principal de service Azure pour Audience Insights](connect-service-principal.md).
...
- **Traitement des informations ajoutées aux pages supplémentaires**
...
- **Enrichissement des affinités d'intérêt disponible sur d'autres marchés**

  Nous étendons la disponibilité de l'enrichissement des affinités d'intérêt au-delà des États-Unis à cinq marchés supplémentaires : le Canada, l'Australie, le Royaume-Uni, la France et l'Allemagne. Avec cette extension, vous pouvez enrichir vos données clients avec des intérêts supplémentaires applicables à ces marchés. Nous enrichirons également vos profils clients situés sur ces marchés en utilisant des données propriétaires locales de Microsoft Graph.
  Pour plus d'informations, consultez [Enrichissement des profils clients avec des affinités de marque et d'intérêt](enrichment-microsoft-graph.md)
...
- **Enrichissement des affinités de marque disponible sur d'autres marchés**

  Nous étendons la disponibilité de l'enrichissement des affinités de marque au-delà des États-Unis à cinq marchés supplémentaires : le Canada, l'Australie, le Royaume-Uni, la France et l'Allemagne. Avec cette extension, vous pouvez enrichir vos données clients avec des marques locales sur ces marchés. Nous enrichirons également vos profils clients situés sur ces marchés en utilisant des données propriétaires locales de Microsoft Graph.
  Pour plus d'informations, consultez [Enrichissement des profils clients avec des affinités de marque et d'intérêt](enrichment-microsoft-graph.md)
...
- **Enrichissement avec les données d'entreprise de Leadspace**
  ...
  Définissez des champs dans les profils client unifiés qui sont utilisés pour rechercher des données d'entreprises associées à partir de Leadspace. Après l'exécution du processus d'enrichissement, les profils B2B sont enrichis d'attributs supplémentaires, notamment la taille de l'entreprise, sa localisation, son secteur d'activité, etc.    
...
- **Chronologie et pagination mises à jour sur le complément de carte client**
  ...
  La chronologie de la solution Complément de carte client correspond à la chronologie de l'activité. La pagination de la chronologie s'est améliorée, montrant jusqu'à 50 activités à la fois. Il permet également de charger des activités supplémentaires dans la chronologie.    
  Pour plus d'informations, voir [Complément de carte client](customer-card-add-in.md).
...
- **Exporter vers LiveRamp**
  ...
  Activez vos données dans LiveRamp® pour vous connecter à plus de 500 plateformes à travers les écosystèmes numériques, sociaux et télévisuels. Tirez parti de vos données dans LiveRamp pour cibler, supprimer et personnaliser des campagnes publicitaires.    
