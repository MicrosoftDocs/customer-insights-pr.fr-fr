...
La page **Autorisations** est l'endroit où vous définirez les rôles et les autorisations pour utiliser Audience Insights.

Vous devez disposer des autorisations d'administration pour voir la page. Pour accéder à la page des autorisations dans Audience Insights, accédez à **Administration** > **Autorisations**.
...
1. Dans Audience Insights, accédez à **Administration** > **Autorisations**.
...
Dans Audience Insights, accédez à **Administration** > **Autorisations** pour voir quelles attributions de rôle sont actuellement actives.
